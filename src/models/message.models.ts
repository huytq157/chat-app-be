...
export interface IMessage extends Document {
  ...
  type: 'text' | 'image' | 'video' | 'file' | 'audio' | 'voice' | 'location' | 'contact' | 'sticker' | 'gif' | 'poll' | 'system' | 'forwarded' | 'reply' | 'story' | 'live' | 'call';  // Loại tin nhắn
  content: {                                            // Nội dung tin nhắn
    text?: string;                                      // Văn bản
    media?: {                                           // Media (ảnh, video, file)
    ...
    poll?: {                                            // Khảo sát
      ...
      options: Array<{                                  // Các lựa chọn
        ...
        votes: Array<{                                  // Danh sách bình chọn
  ...
  forwardedFrom?: {                                     // Thông tin chuyển tiếp
  ...
  reactions: Array<{                                    // Phản ứng với tin nhắn
    user: mongoose.Types.ObjectId;                      // ID người dùng
    emoji: string;                                      // Emoji
