...
export interface IConversation extends Document {
  ...
  admins: Array<{                                      // Danh sách quản trị viên
    user: mongoose.Types.ObjectId;                     // ID người dùng
  ...
  unreadCount: Array<{                                // Số tin nhắn chưa đọc của mỗi người
    user: mongoose.Types.ObjectId;                     // ID người dùng
  ...
  pinnedMessages: Array<{                              // Tin nhắn đã ghim
  ...
  scheduledMessages: Array<{                           // Tin nhắn đã lên lịch
    message: mongoose.Types.ObjectId;                  // ID tin nhắn
